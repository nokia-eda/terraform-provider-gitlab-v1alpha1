...
package datasource_cluster_gitlab_issue_list
...
func ClusterGitlabIssueListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterGitlabIssueListModel struct {
