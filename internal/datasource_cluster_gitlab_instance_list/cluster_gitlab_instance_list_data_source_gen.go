...
package datasource_cluster_gitlab_instance_list
...
func ClusterGitlabInstanceListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterGitlabInstanceListModel struct {
