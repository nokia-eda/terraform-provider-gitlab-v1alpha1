...
package resource_gitlab_pipeline
...
func GitlabPipelineResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^GitlabPipeline$"), ""),
				},
				Default: stringdefault.StaticString("GitlabPipeline"),
			},
