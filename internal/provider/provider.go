...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-gitlab/internal/eda/utils"
...
func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &gitlabProvider{version: ver}
	}
}
...
func (p *gitlabProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewGitlabInstanceListDataSource,
		NewGitlabIssueDataSource,
		NewGitlabIssueListDataSource,
		NewGitlabPipelineDataSource,
		NewGitlabPipelineListDataSource,
		NewResourceListDataSource,
		NewRunGitlabPipelineDataSource,
		NewRunGitlabPipelineListDataSource,
...
func (p *gitlabProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewGitlabPipelineResource,
		NewRunGitlabPipelineResource,
	}
}
