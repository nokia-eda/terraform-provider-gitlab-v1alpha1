...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-gitlab/internal/resource_gitlab_instance"
	"github.com/nokia/eda/apps/terraform-provider-gitlab/internal/tfutils"
)

const (
	create_rs_gitlabInstance = "/apps/gitlab.eda.nokia.com/v1alpha1/namespaces/{namespace}/gitlabinstances"
	read_rs_gitlabInstance   = "/apps/gitlab.eda.nokia.com/v1alpha1/namespaces/{namespace}/gitlabinstances/{name}"
	update_rs_gitlabInstance = "/apps/gitlab.eda.nokia.com/v1alpha1/namespaces/{namespace}/gitlabinstances/{name}"
	delete_rs_gitlabInstance = "/apps/gitlab.eda.nokia.com/v1alpha1/namespaces/{namespace}/gitlabinstances/{name}"
)

var (
	_ resource.Resource                = (*gitlabInstanceResource)(nil)
	_ resource.ResourceWithConfigure   = (*gitlabInstanceResource)(nil)
	_ resource.ResourceWithImportState = (*gitlabInstanceResource)(nil)
)

func NewGitlabInstanceResource() resource.Resource {
...
func (r *gitlabInstanceResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gitlab_instance"
}

func (r *gitlabInstanceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_gitlab_instance.GitlabInstanceResourceSchema(ctx)
}

func (r *gitlabInstanceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_gitlab_instance.GitlabInstanceModel
	...
	err = r.client.Create(ctx, create_rs_gitlabInstance, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_gitlabInstance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_gitlabInstance,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *gitlabInstanceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_gitlabInstance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *gitlabInstanceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_gitlabInstance, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
