...
package datasource_create_gitlab_issue_list
...
func CreateGitlabIssueListDataSourceSchema(ctx context.Context) schema.Schema {
...
type CreateGitlabIssueListModel struct {
