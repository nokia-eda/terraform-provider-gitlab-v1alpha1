...
func GitlabIssueResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^GitlabIssue$"), ""),
				},
				Default: stringdefault.StaticString("GitlabIssue"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the GitlabIssue",
				MarkdownDescription: "name of the GitlabIssue",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
