...
package resource_cluster_gitlab_instance
...
func ClusterGitlabInstanceResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterGitlabInstance$"), ""),
				},
				Default: stringdefault.StaticString("ClusterGitlabInstance"),
			},
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"auth_secret_ref": schema.SingleNestedAttribute{
						...
						Optional:            true,
						Description:         "Reference to the secret containing the Gitlab token.",
						MarkdownDescription: "Reference to the secret containing the Gitlab token.",
					},
				},
				CustomType: SpecType{
					ObjectType: types.ObjectType{
				...
				Required:            true,
				Description:         "spec defines the desired state of ClusterGitlabInstance",
				MarkdownDescription: "spec defines the desired state of ClusterGitlabInstance",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of ClusterGitlabInstance",
				MarkdownDescription: "status defines the observed state of ClusterGitlabInstance",
			},
		},
	}
}

type ClusterGitlabInstanceModel struct {
