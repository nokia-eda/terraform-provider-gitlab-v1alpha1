...
package resource_cluster_gitlab_pipeline
...
func ClusterGitlabPipelineResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^gitlab\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("gitlab.eda.nokia.com/v1alpha1"),
			},
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterGitlabPipeline$"), ""),
				},
				Default: stringdefault.StaticString("ClusterGitlabPipeline"),
			},
			...
			"spec": schema.SingleNestedAttribute{
					...
					"trigger": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"alarm": schema.SingleNestedAttribute{
								...
								Optional:            true,
								Description:         "Alarm to Create the issue.",
								MarkdownDescription: "Alarm to Create the issue.",
							},
				...
				Required:            true,
				Description:         "spec defines the desired state of ClusterGitlabPipeline",
				MarkdownDescription: "spec defines the desired state of ClusterGitlabPipeline",
			},
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"conditions": schema.ListNestedAttribute{
						...
						Optional:            true,
						Computed:            true,
						Description:         "conditions represent the current state of the ClusterGitlabPipeline resource.\nEach condition has a unique type and reflects the status of a specific aspect of the resource.\n\nStandard condition types include:\n- \"Available\": the resource is fully functional\n- \"Progressing\": the resource is being created or updated\n- \"Degraded\": the resource failed to reach or maintain its desired state\n\nThe status of each condition is one of True, False, or Unknown.",
						MarkdownDescription: "conditions represent the current state of the ClusterGitlabPipeline resource.\nEach condition has a unique type and reflects the status of a specific aspect of the resource.\n\nStandard condition types include:\n- \"Available\": the resource is fully functional\n- \"Progressing\": the resource is being created or updated\n- \"Degraded\": the resource failed to reach or maintain its desired state\n\nThe status of each condition is one of True, False, or Unknown.",
					},
				},
				...
				Optional:            true,
				Computed:            true,
				Description:         "status defines the observed state of ClusterGitlabPipeline",
				MarkdownDescription: "status defines the observed state of ClusterGitlabPipeline",
			},
		},
	}
}

type ClusterGitlabPipelineModel struct {
