...
page_title: "gitlab-v1alpha1_gitlab_issue_list Data Source - gitlab-v1alpha1"
subcategory: ""
description: |-
  
---

# gitlab-v1alpha1_gitlab_issue_list (Data Source)
...
- `spec` (Attributes) spec defines the desired state of GitlabIssue (see [below for nested schema](#nestedatt--items--spec))
...
- `status` (Attributes) status defines the observed state of GitlabIssue (see [below for nested schema](#nestedatt--items--status))
