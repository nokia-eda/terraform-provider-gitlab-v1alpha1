...
page_title: "gitlab-v1alpha1_cluster_gitlab_issue Data Source - gitlab-v1alpha1"
subcategory: ""
description: |-
  
---

# gitlab-v1alpha1_cluster_gitlab_issue (Data Source)
...
- `spec` (Attributes) spec defines the desired state of ClusterGitlabIssue (see [below for nested schema](#nestedatt--spec))
